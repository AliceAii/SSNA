---
title: 'SSNA 7 Deliverable: One-mode Interactive Network Visualization'
...
# Deliverable 7 Replicate the One-mode interactive network visualization

## Here is what I did

-   **Prepare and the datasets for the author-publication relationship.**
...
-   **Transform the two-mode edgelist into one-mode edgelist.**

    -   Used get.incidence function.

    -   Saved the one-mode edgelist as g.

-   **Prepare Nodes and Links datasets.**

    -   For actor nodes, they contain Author, Affiliations, and Publication number, and the size based on betweenness centrality.

    -   For links, they contain the number of publications for the co-authorship (referred as E(g)\$weight).
...
-   **For visualization:**
    ...
    -   It gives us a clear understanding of the co-authorship.
...
-   **For analysis:**
    ...
    -   It contains more information about the co-authorship.

    -   And we can easily navigate the how many publications they write together.
